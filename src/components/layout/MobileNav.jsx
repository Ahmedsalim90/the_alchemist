...
import { NAV_LINKS, SOCIAL_LINKS } from './navData'
import {
  CloseIcon,
  ChevronIcon,
  ThemeIcon,
  ...
  return (
    <>
      ...
      >
        ...
        <nav
          aria-label="Primary"
          className="flex flex-1 flex-col items-center justify-center gap-6 border-b border-border px-8"
        >
          {NAV_LINKS.map((link) => (
